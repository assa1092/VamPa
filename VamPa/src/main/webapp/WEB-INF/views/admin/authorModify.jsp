    ...
    <%@include file="../includes/admin/header.jsp" %>
                ...
                <div class="admin_content_wrap">
                    ...
                    <div class="admin_content_main">
                    	<form action="/admin/authorModify" method="post" id="modifyForm">
...
<script type="text/javascript">
	...
	$("#cancelBtn").on("click", function(e){
		...
		moveForm.attr("action", "/amdin/authorDetail");
		moveForm.submit();
	});
	
	// 수정 버튼 클릭시 이동 및 유효성 검사
	$("#modifyBtn").on("click", function(e){
		let authorName = $(".form_section_content input[name='authorName']").val();
		let authorIntro = $(".form_section_content textarea[name='authorIntro']").val();
