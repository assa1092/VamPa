...
<body>
	...
	<div class="content_wrap">
		...
		<div class="author_table_wrap">
			...
			<div class="search_wrap">
				<form action="/admin/authorPop" method="get" id="searchForm">
					<div class="search_input">
						...
						<button class="btn search_btn" id="search_btn">검 색</button>
					</div>
				</form>
			</div>
	...
	<script type="text/javascript">
		...
		$(".move").on("click", function(e){
			...
			let authorName = $(this).data("name");		// a 태그안에 data 중  name이라는 변수값 
			
			// opener.document 팝업창을 연 부모창의 id를 찾아서 값을 넣는다. 
